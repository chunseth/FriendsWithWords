...
alter table public.scores
  ...
  check (score_mode in ('solo', 'multiplayer', 'mini'));
...
grant execute on function public.claim_push_delivery_jobs(
  integer,
  text
) to service_role;
grant execute on function public.complete_push_delivery_job(
  uuid,
  boolean,
  text,
  jsonb,
